...
DROP TABLE IF EXISTS day00.ChristmasList;
DROP TABLE IF EXISTS day00.Children;
DROP TABLE IF EXISTS day00.Gifts;
DROP TABLE IF EXISTS day00.Reindeer;

-- Create tables
CREATE TABLE day00.Children (
...
CREATE TABLE day00.ChristmasList (
...
INSERT INTO day00.Children VALUES
...
INSERT INTO day00.Gifts VALUES
...
INSERT INTO day00.ChristmasList VALUES
(1, 1, 1, 2023, TRUE, 1),
(2, 2, 2, 2023, TRUE, 2),
(3, 3, 3, 2023, TRUE, 3),
(4, 4, 4, 2023, TRUE, 4),
...
INSERT INTO day00.Reindeer VALUES
(1, 'Dasher', 500, 'Europe'),
(2, 'Dancer', 450, 'Asia'),
