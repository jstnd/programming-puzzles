...
mod aoc {
    ...
    mod year2016 {
        benchmark_aoc!(year2016, day01);
        benchmark_aoc!(year2016, day02);
    }

    mod year2017 {
        benchmark_aoc!(year2017, day01);
        benchmark_aoc!(year2017, day02);
    }
    ...
    mod year2019 {
        ...
        benchmark_aoc!(year2019, day04);
        benchmark_aoc!(year2019, day05);
    }
    ...
    mod year2024 {
        ...
        benchmark_aoc!(year2024, day24);
        benchmark_aoc!(year2024, day25);
    }

    mod year2025 {
        benchmark_aoc!(year2025, day01);
        benchmark_aoc!(year2025, day02);
        benchmark_aoc!(year2025, day03);
        benchmark_aoc!(year2025, day04);
        benchmark_aoc!(year2025, day05);
        benchmark_aoc!(year2025, day06);
        benchmark_aoc!(year2025, day07);
        benchmark_aoc!(year2025, day08);
        benchmark_aoc!(year2025, day09);
        benchmark_aoc!(year2025, day10);
        benchmark_aoc!(year2025, day11);
        benchmark_aoc!(year2025, day12);
    }
}
